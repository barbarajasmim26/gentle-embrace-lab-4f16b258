...
- [x] Corrigir o link de redirecionamento do WhatsApp no sistema
- [x] Ajustar o recibo para ficar igual ao sistema anterior
- [x] Corrigir a abertura do arquivo de contrato do Adones no sistema
- [ ] Corrigir erro de inserção de pagamento ao gerar recibos (type mismatch no campo amount)
- [ ] Enviar as correções do projeto para o GitHub
